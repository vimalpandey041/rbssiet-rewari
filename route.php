...
<div class="container">
    <div class="row">
       <div class="col-4">
        <div class="route-box ">
           <div class="card text-center card-h2" >
           <div class="card-header">
                <span class="h3 text-uppercase ">By Road</span>
            </div>
            <div class="card-body">
        ...
        <div class="col-4">
            <div class="card">
                <h2 class="card-title text-center">By Train</h2>
                <p>
        ...
        <div class="col-4">
            <div class="card">
                ...
                <p>Indira Gandhi International Airport(T3)                58 KMs</p>
            </div>
        </div>
    </div>
</div>
